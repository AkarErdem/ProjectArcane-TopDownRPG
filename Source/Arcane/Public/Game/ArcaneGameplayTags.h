...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Inputs_Tag_LMB);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Inputs_Tag_RMB);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Inputs_Tag_1);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Inputs_Tag_2);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Inputs_Tag_3);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Inputs_Tag_4);

// UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Passive_1);
// UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Passive_2);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(Meta_Tag_Damage);
/*
...
*/
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Abilities_Tag_HitReact);
/*
